CREATE OR REPLACE FUNCTION generar_num_transaccion_pago()
    RETURNS trigger AS $$
DECLARE
...
DROP TRIGGER IF EXISTS trg_generar_num_transaccion_pago ON pago;

CREATE TRIGGER trg_generar_num_transaccion_pago
    BEFORE INSERT ON pago
    FOR EACH ROW
EXECUTE FUNCTION generar_num_transaccion_pago();
